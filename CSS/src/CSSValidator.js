...
class CSSValidator {
    ...
    validateProperty(propertyName) {
        ...
        if (propertyName.startsWith('--')) {
            result.valid = true;
            result.category = 'custom-properties';
            result.isCustomProperty = true;
            result.syntax = '<declaration-value>';
            return result;
        }
        ...
        for (const prefix of vendorPrefixes) {
            if (propertyName.startsWith(prefix)) {
                result.valid = true;
                result.category = 'vendor-prefix';
                result.isVendorPrefix = true;
                result.syntax = 'vendor-specific';
                return result;
            }
        }
